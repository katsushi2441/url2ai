...
.u2a-badge { background: #e11d48; color: #fff; font-size: 10px; font-weight: 700; padding: 1px 6px; border-radius: 8px; letter-spacing: .03em; }
...
<div class="header">
    ...
    <?php if ($detail_post): ?>
    <div class="logo-group"><div class="logo"><a href="<?php echo $THIS_FILE; ?>" style="text-decoration:none;color:inherit;">AI News <span>Radar</span></a></div><span class="u2a-badge">URL2AI</span></div>
    ...
    <a class="back-btn" href="<?php echo $THIS_FILE; ?>">← 一覧</a>
    <?php else: ?>
    <div class="logo-group"><div class="logo">AI News <span>Radar</span></div><span class="u2a-badge">URL2AI</span></div>
