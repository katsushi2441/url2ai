...
if($_SERVER['REQUEST_METHOD']==='POST'&&$is_admin){
    ...
    if($act==='post_tweet'){
        ...
        if($post_text===''){$msg_err='empty text';}
            ...
            $res=np_post_tweet($post_text,$post_type==='reply'?$reply_id:'',$post_type==='quote'?$quote_url:'',$o1_key,$o1_secret,$o1_token,$o1_token_secret);
...
<div class="form-row"><label class="form-label">memo (private)</label><input type="text" name="memo"></div>
