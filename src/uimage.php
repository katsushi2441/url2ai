...
<body>
<header>
    <div class="logo-group"><div class="logo">U<span>Image</span></div><span class="u2a-badge">URL2AI</span>Image</div>
    <div class="userbar">
        <?php if ($logged_in): ?>
