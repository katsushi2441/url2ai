...
name: llm2api
description: >
  LLM2API provides Gemma 4 12B (gemma4:12b-it-qat) text generation via an
...
# LLM2API — Gemma 4 12B Inference

OpenAI-compatible LLM inference powered by [Gemma 4 12B](https://ai.google.dev/gemma) (gemma4:12b-it-qat) via Ollama.
