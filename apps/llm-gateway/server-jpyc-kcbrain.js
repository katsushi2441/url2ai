...
const JPYC_AMOUNT       = process.env.JPYC_AMOUNT_KCBRAIN       || "7500000000000000000";  // 7.5 JPYC ≒ $0.05
const JPYC_AMOUNT_CHAIN = process.env.JPYC_AMOUNT_KCBRAIN_CHAIN || "7500000000000000000";  // 7.5 JPYC ≒ $0.05(全スキル統一)
